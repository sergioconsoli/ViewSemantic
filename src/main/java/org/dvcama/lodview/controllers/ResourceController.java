...
public class ResourceController {
	...
	private void addLodliveLink(Locale locale, ModelMap model, String IRI) {
		if (locale.getLanguage().equals("it")) {
			...
			model.addAttribute("lodliveUrl", "https://culturalgemsdev.jrc.cec.eu.int/static/media/lodlive/app_it.html?" + IRI.replaceAll("#", "%23"));
		} else if (locale.getLanguage().equals("fr")) {
			//model.addAttribute("lodliveUrl", "http://fr.lodlive.it?" + IRI.replaceAll("#", "%23"));
			model.addAttribute("lodliveUrl", "https://culturalgemsdev.jrc.cec.eu.int/static/media/lodlive/app_fr.html?" + IRI.replaceAll("#", "%23"));
		} else if (locale.getLanguage().equals("gl")) {
			//model.addAttribute("lodliveUrl", "http://gl.lodlive.it?" + IRI.replaceAll("#", "%23"));
			model.addAttribute("lodliveUrl", "https://culturalgemsdev.jrc.cec.eu.int/static/media/lodlive/app_gl.html?" + IRI.replaceAll("#", "%23"));
		} else {
			//model.addAttribute("lodliveUrl", "http://en.lodlive.it?" + IRI.replaceAll("#", "%23"));
			model.addAttribute("lodliveUrl", "https://culturalgemsdev.jrc.cec.eu.int/static/media/lodlive/app_en.html?" + IRI.replaceAll("#", "%23"));
		}
	}
